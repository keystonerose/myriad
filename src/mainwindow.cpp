...
namespace myriad {
    namespace ui {
        ...
        // Even though we don't take any action within the MainWindow destructor, it is necessary to define it
        // explicitly here. If we don't, the compiler provides inline versions in the header file, at which point the

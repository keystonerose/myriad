        ...
        */
        ...
        class MainWindow : public KXmlGuiWindow {
            ...
            public:
                ...
                /**
                * Initialises the main Myriad window and performs the steps needed to set up its GUI and binds its
                * methods to particular actions.
                */
                ...
                */
                ...
                /**
                * Gets a list of all the targets that the user has loaded into the MainWindow's input list, each of
                * which will be a full filesystem path to an image file or a directory.
                ...
                */
                ...
                /**
                * Called before the main window is closed, information about its current state to be saved so that it
                * can be restored the next time Myriad is run.
            ...
            public slots:
                ...
                */
                ...
                /**
                * Sets the number of files and folders that Myriad has currently scanned for processing, and displays
                * this information in the main UI.
                ...
                */
                ...
                /**
                * Sets the current processing phase that Myriad is executing, and displays this information in the main
                * UI.

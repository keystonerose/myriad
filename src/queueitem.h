    ...
    namespace modelview {
        ...
        public:
            ...
            */
            ...
            /**
            * Gets data associated with this item, which may be a full path usable in file operations (if Role::PathRole
            * is specified), a file or directory name only (if Qt::DisplayRole is specified) or an icon (if
            * Qt::DecorationRole is specified).
            ...
            */
            ...
            /**
             * Sets the data associated this item. This must be called with a full path usable in file operations, as
             * the data associated with other roles of this item (i.e. its icon and its name) do not provide enough
             * information to fully determine it.
